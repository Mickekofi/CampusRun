...
│   ├── lib/
│   │   ├── core/              # Constants, API configs (admin_ip.dart), themes
│   │   ├── screens/           # UI Views
│   │   │   ├── Admin/         # Admin dashboards (Asset creation, Route pricing)
│   │   │   └── Users/         # Student-facing screens (Scan, Wallet, RideMode)
│   │   └── widgets/           # Reusable UI components (AppStatusChip, etc.)
│   ├── pubspec.yaml
│   └── README.md
│
...
│   ├── controllers/           # Business logic and database execution
│   │   ├── Admin/             # Controllers for asset/station management
│   │   └── Users/             # Controllers for QR scans, wallets, active rides
│   ├── routes/                # API endpoint definitions mapping to controllers
│   │   ├── Admin/
│   │   └── Users/
│   ├── package.json
│   └── server.js              # Application entry point and global middleware
│
├── database/                  # Database Schema & Migrations
│   └── init.sql               # Core schema definitions (users, bikes, rides, payments)
│
├── product-engineering-architecture.md  # You are here
